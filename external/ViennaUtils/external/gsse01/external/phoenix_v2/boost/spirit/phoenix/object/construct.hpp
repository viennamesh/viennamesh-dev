...
namespace boost { namespace phoenix
{
        ...
        struct construct_eval
        {
            template <typename Env,
                BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(
                    PHOENIX_COMPOSITE_LIMIT, typename T, void_type)>
            struct apply
            {
                typedef T type;
            };
            ...
            #include <boost/spirit/phoenix/object/detail/construct_eval.hpp>
        };
    }
    ...
    #include <boost/spirit/phoenix/object/detail/construct.hpp>
}}
