...
#include <boost/spirit/phoenix/operator/detail/mem_fun_ptr_return.hpp>
...
namespace boost { namespace phoenix {
    ...
    struct mem_fun_ptr_eval
    {
        ...
        struct apply
            : detail::mem_fun_ptr_return<typename apply_actor<MemFunPtrActor, Env>::type> { };

        template<typename Rt, typename Env, typename PtrActor, typename MemFunPtrActor>
        static typename apply<Env,PtrActor,MemFunPtrActor>::type
...
#define BOOST_PP_ITERATION_PARAMS_1                                                                                 \
        (3, (1, BOOST_PP_SUB(PHOENIX_MEMBER_LIMIT, 2), "boost/spirit/phoenix/operator/detail/mem_fun_ptr_eval.hpp"))
...
#define PHOENIX_EVAL_ARG(z,n,_) arg ## n.eval(env)        
        ...
        static typename apply<Env,PtrActor,MemFunPtrActor, BOOST_PP_ENUM_PARAMS(PHOENIX_ITERATION,Arg)>::type
        eval(const Env& env, PtrActor& ptrActor, MemFunPtrActor& memFunPtrActor,
