...
//      by checking if it has a member type named "storage_type".
//
///////////////////////////////////////////////////////////////////////////////
    namespace stl_impl
    {
        ...
        template <typename C>
        one has_storage_type(typename C::storage_type(*)());

        template <typename C>
        two has_storage_type(...);
    }

    template <typename C>
    struct has_storage_type
        : boost::mpl::bool_<
            sizeof(stl_impl::has_storage_type<C>(0)) == sizeof(stl_impl::one)
        >
    {};
