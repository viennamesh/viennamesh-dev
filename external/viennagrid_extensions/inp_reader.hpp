...
namespace io
{
   ...
   struct inp_reader
   {
      ...
      {       
         // geometry storage
         typedef viennagrid::point_t<numeric_type, viennagrid::cartesian_cs<DIMG> >         point_type;
                              ...
                              std::map<std::size_t, CellComplexT>&   seg_cell) const
      {
         ...
         typedef typename viennagrid::result_of::ncell<domain_config_type, cell_tag::dim>::type     cell_type;         
...
//         }
         ...
         static const std::size_t CELLSIZE = viennagrid::topology::bndcells<cell_tag, 0>::num;         
