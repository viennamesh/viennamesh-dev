...
void AnisotropicClusters ::  Update()
{
  ...
  /*
    ...
    std::cout << "c" << i-nv-ned-nfa << " ";
    std::cout << cluster_reps.Get(i) << endl;
    }
  */
}
}
