	  ...
	  while (ch == '(')
	    {
	      ...
	      //std::cout << "read line " << lin.I1() << " " << lin.I2() << endl;
	      lines.Append (lin);
	      ...
	      while (ch != ';')
		{
		  //std::cout << "working on character \""<<ch<<"\""<< endl;
		  if (ch == '{')
		    {
		  ...
		  else if (ch == 'd')
		    {
		      ...
		      ist >> ch; // 'e'
		      ist >> ch; // 'l'
		      //std::cout << "read del" << endl;
		    }

		  ist >> ch;
		  //std::cout << "read character \""<<ch<<"\""<< endl;
		}

	      ist >> ch;
	      //std::cout << "read next character \""<<ch<<"\""<< endl;
	    }
