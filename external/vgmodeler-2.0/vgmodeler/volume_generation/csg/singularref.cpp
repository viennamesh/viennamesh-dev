...
{
  std::cout << "find points on edge" << endl;
  int j;
  points.SetSize(0);
  segms.SetSize(0);
  ...
  /*
  std::cout << "Singular edge points:" << endl;
...
void SingularPoint :: FindPoints (class Mesh & mesh)
{
  ...
  for (PointIndex pi = PointIndex::BASE; 
       pi < mesh.GetNP()+PointIndex::BASE; pi++)
    {
      ...
      std::cout << "check singular point" << p << endl;
