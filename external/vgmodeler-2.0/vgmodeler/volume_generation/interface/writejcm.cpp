                     ...
                     const string & filename)
{
  ...
  // Identic points
  ARRAY<INDEX,1> identmap1, identmap2, identmap3;
  ...
  for (i = 1; i <= ne; i++)
  {
    ...
    {
      counter++;
      dx1 = mesh.Point(el.PNum(2)).X() - mesh.Point(el.PNum(1)).X();
      dx2 = mesh.Point(el.PNum(3)).X() - mesh.Point(el.PNum(1)).X();
      dx3 = mesh.Point(el.PNum(4)).X() - mesh.Point(el.PNum(1)).X();
      dy1 = mesh.Point(el.PNum(2)).Y() - mesh.Point(el.PNum(1)).Y();
      dy2 = mesh.Point(el.PNum(3)).Y() - mesh.Point(el.PNum(1)).Y();
      dy3 = mesh.Point(el.PNum(4)).Y() - mesh.Point(el.PNum(1)).Y();
      dz1 = mesh.Point(el.PNum(2)).Z() - mesh.Point(el.PNum(1)).Z();
      dz2 = mesh.Point(el.PNum(3)).Z() - mesh.Point(el.PNum(1)).Z();
      dz3 = mesh.Point(el.PNum(4)).Z() - mesh.Point(el.PNum(1)).Z();
