			   ...
			   Point3d & p)
{
  ...
  */
  ...
  /*
  std::cout << "findip, a now = " << endl << a << endl;
  std::cout << "findip, c now = " << endl << c << endl;
  */
  ...
  // std::cout << "findip, f = " << f << ", hmax = " << hmax << endl;
  return (f < -1e-5 * hmax);
}
