...
#
#  THREADS_PTHREADS_WIN32_SUFFIX
#      Setting this will add on the specified suffix to the library 
#      name which is searched for.
#      A Typical application would be to differentiate between 32-bit
#      and 64-bit versions using "_Win32" and "_x64"
#
#======================================================
...
ENDIF(WIN32 AND NOT CYGWIN AND THREADS_USE_PTHREADS_WIN32)
...
ELSEIF(_Threads_ptwin32)
	...
	ELSE(NOT DEFINED THREADS_PTHREADS_WIN32_EXCEPTION_SCHEME)
		...
		ENDIF(NOT THREADS_PTHREADS_WIN32_EXCEPTION_SCHEME STREQUAL "C" AND
		     NOT THREADS_PTHREADS_WIN32_EXCEPTION_SCHEME STREQUAL "CE" AND
	         NOT THREADS_PTHREADS_WIN32_EXCEPTION_SCHEME STREQUAL "SE")
	...
	ENDIF(NOT DEFINED THREADS_PTHREADS_WIN32_EXCEPTION_SCHEME)

	IF(NOT DEFINED THREADS_PTHREADS_WIN32_SUFFIX)
		SET(THREADS_PTHREADS_WIN32_SUFFIX )
	ENDIF(NOT DEFINED THREADS_PTHREADS_WIN32_SUFFIX)
	...
	IF(MSVC)
		SET(_Threads_pthreads_libname
			pthreadV${THREADS_PTHREADS_WIN32_EXCEPTION_SCHEME}2${THREADS_PTHREADS_WIN32_SUFFIX})
	ELSEIF(MINGW)
		SET(_Threads_pthreads_libname
			pthreadG${THREADS_PTHREADS_WIN32_EXCEPTION_SCHEME}2${THREADS_PTHREADS_WIN32_SUFFIX})
	ELSE(MSVC)
	...
	ENDIF(THREADS_PTHREADS_INCLUDE_DIR AND THREADS_PTHREADS_WIN32_LIBRARY)
...
IF(CMAKE_SYSTEM MATCHES "Windows" AND NOT THREADS_USE_PTHREADS_WIN32)
	...
	ELSE(MFC_FOUND)
		...
		SET(Threads_FOUND FALSE)
	ENDIF(MFC_FOUND)	
ENDIF(CMAKE_SYSTEM MATCHES "Windows" AND NOT THREADS_USE_PTHREADS_WIN32)
...
ELSE(_Threads_ptwin32)
	FIND_PACKAGE_HANDLE_STANDARD_ARGS(Threads 
	                                 DEFAULT_MSG 
									 Threads_FOUND
									 )
ENDIF(_Threads_ptwin32)
