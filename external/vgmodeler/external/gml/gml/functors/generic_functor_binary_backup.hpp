...
{  
   ...
   AlgorithmResult
   operator()( Geometry          const& geometry, 
               TopologyElement1  const& ele1,
               TopologyElement2  const& ele2 )
   {
      ...
      typedef typename gsse::array< ConformMetricObject, DIMResult1+1 >   ConformGeometryCell1;
      ConformGeometryCell1 conform_geometry_cell1;  
      typedef typename gsse::array< ConformMetricObject, DIMResult2+1 >   ConformGeometryCell2;
