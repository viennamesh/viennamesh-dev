...
#include <boost/spirit/phoenix/detail/local_reference.hpp>
...
namespace boost { namespace phoenix
{
    ...
    namespace detail
    {
        ...
        struct initialize_local
        {
            ...
            struct apply // $$$ TODO: remove this after switch to Fusion V2 $$$
            {
                typedef typename remove_reference<Actor>::type actor;
                typedef typename actor::template result<Env>::type type;
            };
