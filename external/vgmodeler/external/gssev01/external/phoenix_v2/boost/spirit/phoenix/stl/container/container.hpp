...
#include <boost/spirit/phoenix/stl/container/detail/container.hpp>
...
//
//      The structs provide a nested "apply" class template whose
...
///////////////////////////////////////////////////////////////////////////////
    namespace stl
    {
        struct assign
        {
            template <
                typename C
              , typename Arg1 = void_type
              , typename Arg2 = void_type
              , typename Arg3 = void_type
            >
            struct apply
            {
        ...
        struct erase
        {
            ...
            template <typename C, typename Arg1, typename Arg2 = void_type>
            struct apply
            {
            ...
            template <typename C, typename Arg1, typename Arg2>
            typename apply<C, Arg1, Arg2>::type
        ...
        struct insert
        {
            ...
            template <typename C, typename Arg1, typename Arg2, typename Arg3>
            typename apply<C, Arg1, Arg2, Arg3>::type
            operator()(
