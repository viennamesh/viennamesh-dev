...
namespace netgen
{
  ...
  void RevolutionFace :: CalcGradient (const Point<3> & point, Vec<3> & grad) const
  {
	...
	//std::cout << "grad1("<<point<<") = " << grad << endl;
      }
    else
      {
	...
	//std::cout << "grad2("<<point<<") = " << grad << endl;
      }
  }
  ...
  void RevolutionFace :: CalcHesse (const Point<3> & point, Mat<3> & hesse) const
  {
	...
	//std::cout << "hesse2: " << hesse <<endl;
      ...
      {
	hesse = 0;
	//std::cout << "hesse3: " << hesse <<endl;
      }
    else
      {
	std::cout << "hesse4: " << hesse <<endl;
      }
  }
  ...
  double  RevolutionFace :: MaxCurvature() const
  {
	...
	//if(ss3)
	//  std::cout << "t1 " << t1 << " t2 " << t2 << " c1 " << c1 << " c2 " << c2 << endl;
    ...
    //if(ss3)
    //  std::cout << "curvature " << retval << endl;
  ...
  */
					   ...
					   double eps) const
  {
    ...
    //std::cout << "face intersections at: " << endl;
    for(int i=0; i<faces.Size(); i++)
      {
