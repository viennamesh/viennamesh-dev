...
void vnetrule :: SetFreeZoneTransformation (const Vector & allp, int tolclass)
{
  ...
  /*
  std::cout << "Transformed freezone: " << endl;
  for (i = 1; i <= transfreezone.Size(); i++)
    std::cout << transfreezone.Get(i) << " ";
  std::cout << endl;
  */
}
				     ...
				     const ARRAY<int> & pi, int newone)
{
  ...
  /*
  std::cout << "trig in free set : " << p1 << " - " << p2 << " - " << p3 << endl;
  std::cout << "common points: " << cnt << endl;
  */
  if (!newone)
    cnt = 0;
  ...
  if (cnt == 1)
      ...
      for (i = 1; i <= freesetfaces.Size(); i++)
	{
	  if ( (freesetfaces.Get(i).i1 == lpiu) || 
		...
		continue;
	      ...
	      int out1 = (a * v1) > 0;
	      int out2 = (a * v2) > 0;
	      //	      std::cout << "out1, out2 = " << out1 << ", " << out2 << endl;
	      if (out1 && out2)
		return 0;
...
#ifdef DEBUG
		      std::cout << "lam1 lam2 < 0" << endl;

		      std::cout << "lami different" << endl;
		      std::cout << "v1 = " << v1 << endl;
		      std::cout << "v2 = " << v2 << endl;
		      std::cout << "n = " << n << endl;
		      std::cout << "a = " << a << endl;
		      std::cout << "an = " << an << endl;
		      std::cout << "a * v1 = " << (a * v1) << endl;
		      std::cout << "a * v2 = " << (a * v2) << endl;
		      std::cout << "an * v1 = " << (an * v1) << endl;
		      std::cout << "an * v2 = " << (an * v2) << endl;
		      
		      std::cout << "vii = " << vii11 << ", " << vii12 << ", " << vii22 << endl;
		      std::cout << "lami = " << lam1 << ", " << lam2 << endl;
		      std::cout << "rs = " << rs1 << ", " << rs2 << endl;
#endif
		      continue;
		    }
		}
      ...
      /*
      std::cout << "overlap trig " << p1 << p2 << p3 << endl;
      std::cout << "upi = " << upi << endl;
	...
	case 3:
      ...
      //      std::cout << "orig v1, v2 = " << v1 << ", " << v2 << endl;
      ...
      for (i = 1; i <= freesetfaces.Size(); i++)
	{
	  if ( (freesetfaces.Get(i).i1 == lpiu) || 
	    ...
	    {
	      /*
	      std::cout << "v1, v2, now = " << v1 << ", " << v2 << endl;

	      // freeface has point
	      std::cout << "freesetface: "
		...
		continue;
	      ...
	      //	      std::cout << "a*v1 = " << (a*v1) << " a*v2 = " << (a*v2) << endl;
	      
	      int out1 = (a * v1) > 0;
	      // int out2 = (a * v2) > 0;


	      //	      std::cout << "out1, 2 = " << out1 << ", " << out2 << endl;
		...
		continue;
	      ...
	      //	      std::cout << "lam1, lam2 = " << lam1 << ", " << lam2 << endl;
  ...
  if (cnt == 2)
    {
      //      std::cout << "tripoitns: " << p1 << " " << p2 << " " << p3 << endl;
  ...
  while (1)
...
#ifdef DEBUG
	  std::cout << "it = " << it << endl;
	  std::cout << "lam1/2 = " << lam1 << "  " << lam2 << endl;
#endif
	}
      ...
      if (it > minit)
	{
	  ...
	  std::cout << "h = " << h11 << "  " << h12 << "  " << h22 << endl;
	  std::cout << "active: " << cntout << endl;
	  std::cout << "lam1-lam1old = " << (lam1 - lam1old) << endl;
	  std::cout << "lam2-lam2old = " << (lam2 - lam2old) << endl;
#endif
	}
      ...
      else
	{
	  ...
	  if (it > minit)
	    {
#ifdef DEBUG
	      std::cout << "act1,2,3 = " << act1 << act2 << act3 << endl;
#endif
	    }
				 ...
				 int fs, const ARRAY<int> & pi, int newone)
{
  ...
  /*
  std::cout << "test quad in freeset: " << p1 << " - " << p2 << " - " << p3 << " - " << p4 << endl;
  std::cout << "pi = ";
  for (i = 1; i <= pi.Size(); i++)
    std::cout << pi.Get(i) << " ";
  std::cout << endl;
		...
		if (edge1.Get(k) == pi1 && edge2.Get(k) == pi2)
		  {
		    ...
		    k--;
		    //		    std::cout << "Del edge " << pi1 << "-" << pi2 << endl;
		  }
	      if (!found)
		{
		  edge1.Append (pi2);
		  edge2.Append (pi1);
		  //		  std::cout << "Add edge " << pi1 << "-" << pi2 << endl;
		}
	    }
	}
    }
