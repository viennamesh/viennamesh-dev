...
BaseVector :: operator/= (
  ...
  if (c)
    ...
    {
#ifdef DEBUG
      std::cout << "operator/=: division by zero" << endl;
#endif
      return *this;
    }
  }
 ...
 double * NewDouble (INDEX len)
{
 ...
 void DeleteDouble (INDEX len, double * dp)
{
  if (len < 10)
    delete [] dp;
  else
...
Vector :: Vector (INDEX alength) : BaseVector (alength)
  ...
  if (length)
      ...
      if (!data)
	{
	  length = 0;
#ifdef DEBUG
	  std::cout << "Vector not allocated" << endl;
#endif
	}
    }
  else
...
Vector :: Vector (const Vector & v2)
  ...
  if (length)
	...
	length = 0;
#ifdef DEBUG
	std::cout << "Vector::Vector : Vector not allocated" << endl;
#endif
      }
    }
  else
...
void Vector :: SetLength (INDEX alength)
  ...
  if (!data)
    ...
    length = 0;
#ifdef DEBUG
    std::cout << "Vector::SetLength: Vector not allocated" << endl;
#endif
    }
  }
...
{
#ifdef DEBUG
  std::cout << "Vector::ChangeLength called" << endl;
#endif
...
{
  std::cout << "BaseVector::SetBlockLength was called for a Vector" << std::endl;
}
...
BaseVector & Vector :: operator+= (const BaseVector & v2)
  ...
  if (Length() == hv2.Length())
    ...
    std::cout << "operator+= illegal dimension" << endl;
  return *this;
  }
...
BaseVector & Vector :: Add (double scal, const BaseVector & v2)
  ...
  if (Length() == hv2.Length())
    ...
    std::cout << "Vector::Add: illegal dimension" << endl;
  return *this;
  }
...
BaseVector & Vector :: Set (double scal, const BaseVector & v2)
  ...
  if (Length() == hv2.Length())
    ...
    std::cout << "Vector::Set: illegal dimension" << endl;
  return *this;
  }
...
void Vector :: GetPart (int startpos, BaseVector & v2) const
{
  ...
  if (Length() >= startpos + v2.Length() - 1)
    ...
    std::cout << "Vector::GetPart: Vector to short" << std::endl;
}
...
void Vector :: SetPart (int startpos, const BaseVector & v2)
{
  ...
  if (Length() >= startpos + n - 1)
    ...
    std::cout << "Vector::SetPart: Vector to short" << std::endl;
}
...
void Vector :: AddPart (int startpos, double val, const BaseVector & v2)
{
  ...
  if (Length() >= startpos + n - 1)
    ...
    std::cout << "Vector::AddPart: Vector to short" << std::endl;
}
...
double Vector :: operator* (const BaseVector & v2) const
  ...
  if (Length() == hv2.Length())
    ...
    {
#ifdef DEBUG
      std::cout << "Scalarproduct illegal dimension" << endl;
#endif
    }
  return sum;
  }
...
TempVector Vector :: operator- () const
  ...
  if (sum.Length () == Length())
    ...
    std::cout << "operator+ (Vector, Vector): sum.Length() not ok" << endl;
  return sum;
  }
*/
...
BaseVector & Vector::operator= (const Vector & v2)
  ...
  if (v2.Length() == Length())
    ...
    {
#ifdef DEBUG
      std::cout << "Vector::operator=: not allocated" << endl;
#endif
    }
...
BaseVector & Vector::operator= (double scal)
  ...
  if (!Length()) 
    {
#ifdef DEBUG
      std::cout << "Vector::operator= (double) : data not allocated" << endl;
#endif
    }
