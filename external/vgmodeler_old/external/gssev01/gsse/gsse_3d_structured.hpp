...
#ifndef GSSE_CVL_3D_S_HH
#define GSSE_CVL_3D_S_HH
...
typedef get_topology<3, cuboid_topology_tag, structured_topology_tag>::type     topology_t;
...
typedef segment_traits<segment_t>::edge_on_vertex_direction_left_iterator<1>::type vertex_edge_left_x;
typedef segment_traits<segment_t>::edge_on_vertex_direction_left_iterator<2>::type vertex_edge_left_y;
typedef segment_traits<segment_t>::edge_on_vertex_direction_left_iterator<3>::type vertex_edge_left_z;
