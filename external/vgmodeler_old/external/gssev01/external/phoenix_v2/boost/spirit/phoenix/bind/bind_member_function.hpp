...
{
    //  Bring in the detail::member_function_ptr_0..N definitions
    #include <boost/spirit/phoenix/bind/detail/member_function_ptr.hpp>
    ...
    #include <boost/spirit/phoenix/bind/detail/bind_member_function.hpp>
}}
