...
#include <boost/spirit/phoenix/operator/detail/mem_fun_ptr_gen.hpp>
    ...
    struct member_object_eval
    {
        ...
        struct apply
        {
            typedef typename detail::member_type<
                typename apply_actor<MemPtrActor, Env>::type>::type member_type;

            typedef typename meta::pointed_type<
                typename remove_reference<
                typename apply_actor<PtrActor, Env>::type>::type>::type object_type;
        ...
        static typename apply<Env,PtrActor,MemPtrActor>::type
