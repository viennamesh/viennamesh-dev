...
#include <boost/spirit/phoenix/stl/algorithm/detail/has_sort.hpp>
#include <boost/spirit/phoenix/stl/algorithm/detail/has_remove.hpp>
#include <boost/spirit/phoenix/stl/algorithm/detail/has_remove_if.hpp>
#include <boost/spirit/phoenix/stl/algorithm/detail/has_unique.hpp>
#include <boost/spirit/phoenix/stl/algorithm/detail/has_reverse.hpp>
#include <boost/spirit/phoenix/stl/algorithm/detail/has_sort.hpp>

#include <boost/spirit/phoenix/stl/algorithm/detail/begin.hpp>
#include <boost/spirit/phoenix/stl/algorithm/detail/end.hpp>
#include <boost/spirit/phoenix/stl/algorithm/detail/decay_array.hpp>
...
namespace impl
{
    ...
    {
        template<class R, class T>
        struct apply : range_result_iterator<R>
        {
        };

        template<class R, class T>
        typename apply<R, T>::type execute(R& r, T const& x, mpl::true_) const
        {
            r.remove(x);
        ...
        template<class R, class T>
        typename apply<R, T>::type execute(R& r, T const& x, mpl::false_) const
        {
            return std::remove(detail::begin_(r), detail::end_(r), x);
        }

        template<class R, class T>
        typename apply<R, T>::type operator()(R& r, T const& x) const
        {
    ...
    struct remove_if
    {
        ...
        template<class R, class P>
        typename apply<R, P>::type execute(R& r, P p, mpl::true_) const
        {
            r.remove_if(p);
            return detail::end_(r);
        }
        ...
        template<class R, class P>
        typename apply<R, P>::type execute(R& r, P p, mpl::false_) const
        {
            return std::remove_if(detail::begin_(r), detail::end_(r), p);
        }

        template<class R, class P>
        typename apply<R, P>::type operator()(R& r, P p) const
        {
    ...
    struct unique
    {
        ...
        template<class R>
        typename apply<R>::type execute(R& r, mpl::true_) const
        {
            r.unique();
            return detail::end_(r);
        }
        ...
        template<class R>
        typename apply<R>::type execute(R& r, mpl::false_) const
        {
            return std::unique(detail::begin_(r), detail::end_(r));
        }

        template<class R>
        typename apply<R>::type operator()(R& r) const
        {
        ...
        template<class R, class P>
        typename apply<R>::type execute(R& r, P p, mpl::true_) const
        {
            r.unique(p);
            return detail::end_(r);
        }
    ...
    struct unique_copy
    {
        ...
        typename apply<R, O>::type operator()(R& r, O o) const
        {
        ...
        template<class R, class O, class P>
        typename apply<R, O, P>::type operator()(R& r, O o, P p) const
        {
            return std::unique_copy(
                detail::begin_(r)
                , detail::end_(r)
    ...
    struct rotate_copy
    {
        ...
        template<class R, class M, class O>
        typename apply<R, M, O>::type operator()(R& r, M m, O o) const
        {
    ...
    struct partial_sort_copy
    {
        ...
        struct apply : range_result_iterator<R2>
        {};

        template<class R1, class R2>
        typename apply<R1, R2>::type operator()(R1& r1, R2& r2) const
        {
        ...
        typename apply<R1, R2>::type operator()(R1& r1, R2& r2, C c) const
        {
            return std::partial_sort_copy(
                detail::begin_(r1), detail::end_(r1)
                , detail::begin_(r2), detail::end_(r2)
    ...
    struct merge 
    {
        ...
        typename apply<R1, R2, O>::type operator()(R1& r1, R2& r2, O o) const
        {
            return std::merge(
                detail::begin_(r1), detail::end_(r1)
                , detail::begin_(r2), detail::end_(r2)
        ...
        typename apply<R1, R2, O, C>::type operator()(R1& r1, R2& r2, O o, C c) const
        {
            return std::merge(
                detail::begin_(r1), detail::end_(r1)
                , detail::begin_(r2), detail::end_(r2)
    ...
    struct inner_product
    {
        ...
        typename apply<R,I,T,C1,C2>::type
