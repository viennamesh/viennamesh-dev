...
namespace boost { namespace phoenix {
    ...
    namespace meta
    {
        ...
        struct try_catch_composite_push_back
        {
            ...
            typedef try_catch_composite<
                ...
                typename fusion::meta::push_back<
    ...
    namespace detail
    {
        struct try_catch_composite_push_back
        {
            ...
            template<typename Composite, typename Actor>
            typename apply<Composite, Actor>::type
            operator()(
                const Composite& composite, const Actor& actor) const
            {
                typedef typename apply<Composite, Actor>::type result;
                return result(
                    fusion::generate(
    ...
    struct try_gen
    {
        ...
        try_catch_composite<fusion::tuple<Try> > operator[](
            const Try& try_) const
        {
            typedef fusion::tuple<Try> tuple_type;
