...
IF( NOT OpenCASCADE_FOUND STREQUAL TRUE )
  IF(UNIX)
    set( _incsearchpath /usr/include/oce /usr/include/opencascade /opt/occ/inc $ENV{CASROOT}/inc )
    if (APPLE)
...
#       FIND_LIBRARY( ${_libname}_OCCLIB NAMES ${_libname} HINTS ${OpenCASCADE_LINK_DIRECTORY} NO_DEFAULT_PATH)
