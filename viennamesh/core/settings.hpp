...
//     virtual ScalarType get_scalar() const = 0;
//
//     template<typename T>
...
//
//     virtual bool is_scalar() const { return result_of::is_scalar<T>::value; }
//     virtual ScalarType get_scalar() const { return result_of::scalar_dispatcher<T>::get(value); }
//
...
//
//
//     ParameterHandle get_scalar( string const & name )
//     {
//       ParameterHandle ptr = get(name);
//       if (ptr && ptr->is_scalar())
//         return ptr;
//       else return ParameterHandle();
//     }
//
//     ConstParameterHandle get_scalar( string const & name ) const
//     {
...
//     }
//
//     bool copy_scalar( string const & name, ScalarType & dest ) const
//     {
//       ConstParameterHandle ptr = get(name);
//       if (ptr && ptr->is_scalar())
//       {
