...
namespace viennamesh
{
  ...
  struct BaseConversionFunction
  {
    ...
    virtual shared_ptr<BaseMesh> getConverted( shared_ptr<const BaseMesh> const & ) = 0;
  ...
  struct ConversionFunction : BaseConversionFunction
  {
    ...
    ConversionFunction( function<void (InputMeshT const &, OutputMeshT &)> const & f) :
        BaseConversionFunction(1, OutputMeshT::staticIsViennaGrid()), convert_function(f) {}
    ...
    virtual shared_ptr<BaseMesh> getConverted( shared_ptr<const BaseMesh> const & input_mesh )
    {
  ...
  struct DualConversionFunction : BaseConversionFunction
  {
    ...
    virtual void convert( shared_ptr<const BaseMesh> const & input_mesh, shared_ptr<BaseMesh> const & output_mesh )
    {
      second->convert( first->getConverted(input_mesh), output_mesh );
    }

    virtual shared_ptr<BaseMesh> getConverted( shared_ptr<const BaseMesh> const & input_mesh )
    {
      return second->getConverted( first->getConverted(input_mesh) );
    }
  ...
  public:
    ...
    shared_ptr<BaseMeshT> getNearestViennaGrid(shared_ptr<const BaseMeshT> const & input_mesh)
    {
      ...
      if (imtit != conversions.end())
      {
        ...
        if (best != imtit->second.end())
        {
          return best->second->getConverted(input_mesh);
        }
        else
        {
    ...
    shared_ptr<BaseMeshT> getConverted(shared_ptr<const BaseMeshT> const & input_mesh)
    {
      MeshT::static_init();
      ...
      if (it != conversions.end())
      {
        ...
        if ( jt != it->second.end() )
        {
          return jt->second->getConverted(input_mesh);
        }
      }
  ...
  public:
    ...
    { return converter().getConverted<MeshT>( shared_from_this() ); }

  protected:

    virtual bool isViennaGrid() const = 0;
  ...
  public:
    ...
    {
      MeshHandle vgrid_mesh = BaseMesh::converter().getNearestViennaGrid( shared_from_this() );
      if (vgrid_mesh)
      {
    ...
    bool isViennaGrid() const { return staticIsViennaGrid(); }
    static bool staticIsViennaGrid() { return false; }
  ...
  public:
    ...
    bool isViennaGrid() const { return staticIsViennaGrid(); }
    static bool staticIsViennaGrid() { return true; }
