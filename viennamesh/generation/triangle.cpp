...
// --------------------------------------------------------------------------
mesh_kernel<viennamesh::tag::triangle>::result_type 
mesh_kernel<viennamesh::tag::triangle>::operator()(viennagrid::result_of::domain<viennagrid::config::line_2d>::type & hull_domain) 
{
   return (*this)(boost::make_shared< viennagrid::result_of::domain<viennagrid::config::line_2d>::type >(hull_domain));
}
// --------------------------------------------------------------------------
mesh_kernel<viennamesh::tag::triangle>::result_type 
mesh_kernel<viennamesh::tag::triangle>::operator()(boost::shared_ptr< viennagrid::result_of::domain<viennagrid::config::line_2d>::type > hull_domain) 
{
   this->init();         
   //options = "zpDq";  // conforming, quality delaunay
   // options = "zp"; // constrained delaunay
   // options = "z"; // convex
      ...
      typedef viennagrid::result_of::domain<viennagrid::config::line_2d>::type        HullDomain;
...
void mesh_kernel<viennamesh::tag::triangle>::find_point_in_segment(boost::shared_ptr< viennagrid::result_of::domain<viennagrid::config::line_2d>::type >       hull_domain,
...
template mesh_kernel<viennamesh::tag::triangle>::result_type 
mesh_kernel<viennamesh::tag::triangle>::operator()(
   viennamesh::wrapper<viennamesh::tag::viennagrid, viennagrid::result_of::domain<viennagrid::config::line_2d>::type >& data);
// -----------------------------------------------------------------------------
