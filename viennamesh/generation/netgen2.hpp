...
#ifndef VIENNAMESH_INTERFACE_NETGEN2_HPP
#define VIENNAMESH_INTERFACE_NETGEN2_HPP
...
template<>
struct mesh_kernel <viennamesh::tag::netgen2>
{
private:
   // -------------------------------------------------------------------------------------      
   ...
   // nglib::Ng_mesh is a void* ...
   // this header should be free of netgen specifics, so that it can be 
   // included in projects without including netgen stuff
