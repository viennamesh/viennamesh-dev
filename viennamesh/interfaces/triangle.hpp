...
public:
   ...
   */   
   ...
   {
      (*this)(boost::fusion::make_map<tag::criteria>(tag::minimal()));
   }   
...
private:
   ...
   void setOptions_impl(viennamesh::tag::minimal const&)              { options = "zp";   }      
   void setOptions_impl(viennamesh::tag::constrained_delaunay const&) { options = "zpq";  }
   void setOptions_impl(viennamesh::tag::conforming_delaunay const&)  { options = "zpqD"; }
   // -------------------------------------------------------------------------------------
