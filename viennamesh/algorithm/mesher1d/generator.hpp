    ...
    public:
                                ...
                                seed_point_1d_container & seed_points )
      {
        ...
        for (typename GeometrySegmentationT::const_iterator sit = segmentation.begin(); sit != segmentation.end(); ++sit)
        {
          ...
          generate_mesh<typename GeometrySegmentationT::segment_handle_type, viennagrid::line_1d_mesh, viennagrid::line_1d_segmentation>( *sit, viennagrid_mesh, viennagrid_segmentation, -1, false, -1, seed_point_1d_container(), hole_points );
