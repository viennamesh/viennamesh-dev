...
void viennamesh::io::mesh_writer::write_vmesh( MeshT const & mesh,  SegmentationT const & segmentation, string const & filename )
{
...
bool viennamesh::io::mesh_writer::write( ParameterHandleT const & mesh, std::string const & filename )
{
...
bool viennamesh::io::mesh_writer::generic_run_nonsegmented( const_parameter_handle const & mesh, std::string const & filename )
{
...
template<typename TagT, int DimensionV>
bool viennamesh::io::mesh_writer::generic_run_segmented( const_parameter_handle const & mesh, std::string const & filename )
{
  typedef typename viennamesh::result_of::full_config<TagT, DimensionV>::type FullConfigType;
  typedef typename viennamesh::result_of::thin_config<TagT, DimensionV>::type ThinConfigType;
...
bool viennamesh::io::mesh_writer::generic_run( const_parameter_handle const & mesh, std::string const & filename )
{
  ...
  if ( is_segmented )
    ...
    return generic_run_nonsegmented<TagT, DimensionV>( mesh, filename );
}



bool viennamesh::io::mesh_writer::run_impl()
{
