#ifndef VIENNAMESH_ALGORITHM_VIENNAGRID_PROJECT_HPP
#define VIENNAMESH_ALGORITHM_VIENNAGRID_PROJECT_HPP
...
namespace viennamesh
{
  ...
  namespace project
  {
    ...
    void project( InputMeshT const & input_mesh, InputSegmentationT const & input_segmentation,
    ...
    public:
      ...
      bool generic_run( int target_dimension )
      {
        ...
        if (input_mesh)
        {
          ...
          project( input_mesh().mesh, input_mesh().segmentation, output_mesh().mesh, output_mesh().segmentation );
          return true;
        }
