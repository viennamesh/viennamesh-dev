...
namespace viennamesh
{
  ...
  //       typedef typename hull_segment_container_type::value_type hull_segment_type;
      ...
      typedef typename viennagrid::result_of::iterator<CellRangeType>::type     CellItertorType;
      ...
      for (CellItertorType cit = cells.begin(); cit != cells.end(); ++cit)
      {
