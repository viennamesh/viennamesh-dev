#ifndef VIENNAMESH_ALGORITHM_CGAL_PLC_2D_MESHER_HPP
#define VIENNAMESH_ALGORITHM_CGAL_PLC_2D_MESHER_HPP

#include "viennamesh/domain/cgal_plc_2d.hpp"
...
namespace viennamesh
{
    ...
    struct cgal_plc_2d_settings
    {
        cgal_plc_2d_settings() : shortes_edge_circumradius_ratio(0.125), size_bound(0.0) {}
        cgal_plc_2d_settings(double shortes_edge_circumradius_ratio_, double size_bound_) :
    ...
    template<>
    struct settings_parameter<cgal_plc_2d_settings, parameter_shortes_edge_circumradius_ratio>
    {
        typedef double type;
        
        static type get( cgal_plc_2d_settings const & settings) { return settings.shortes_edge_circumradius_ratio; }
    };
    
    template<>
    struct settings_parameter<cgal_plc_2d_settings, parameter_size_bound>
    {
        typedef double type;
        
        static type get( cgal_plc_2d_settings const & settings) { return settings.size_bound; }
    };
    ...
    namespace result_of
    {
        ...
        {
            typedef cgal_plc_2d_settings type;
        };
    }
