...
int main()
{
  ...
  vtx[0] = viennagrid::make_vertex( geometry->value, PointType(0, 0, 0) );
  vtx[1] = viennagrid::make_vertex( geometry->value, PointType(0, s, 0) );
  vtx[2] = viennagrid::make_vertex( geometry->value, PointType(s, 0, 0) );
  vtx[3] = viennagrid::make_vertex( geometry->value, PointType(s, s, 0) );

  vtx[4] = viennagrid::make_vertex( geometry->value, PointType(0, 0, s) );
  vtx[5] = viennagrid::make_vertex( geometry->value, PointType(0, s, s) );
  vtx[6] = viennagrid::make_vertex( geometry->value, PointType(s, 0, s) );
  vtx[7] = viennagrid::make_vertex( geometry->value, PointType(s, s, s) );
  ...
  // top 4 lines
  lines[4] = viennagrid::make_line( geometry->value, vtx[4], vtx[5] );
  lines[5] = viennagrid::make_line( geometry->value, vtx[5], vtx[7] );
  lines[6] = viennagrid::make_line( geometry->value, vtx[7], vtx[6] );
  lines[7] = viennagrid::make_line( geometry->value, vtx[6], vtx[4] );

  // columns
  lines[8] = viennagrid::make_line( geometry->value, vtx[0], vtx[4] );
  lines[9] = viennagrid::make_line( geometry->value, vtx[1], vtx[5] );
  lines[10] = viennagrid::make_line( geometry->value, vtx[2], vtx[6] );
  lines[11] = viennagrid::make_line( geometry->value, vtx[3], vtx[7] );



  viennagrid::make_plc( geometry->value, lines+0, lines+4 );
  viennagrid::make_plc( geometry->value, lines+4, lines+8 );

  {
    ...
    cur_lines[2] = lines[4];
    cur_lines[3] = lines[8];
    viennagrid::make_plc( geometry->value, cur_lines+0, cur_lines+4 );
  }
