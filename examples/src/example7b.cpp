    ...
    //                 std::cout << det << " " << det2 << std::endl;
            ...
            for (viennagrid::io::viennasap_common::token_t::children_container::iterator it = root->children.begin(); it != root->children.end(); ++it)
            {
                ...
                if ( contact_geometry == "flatbottom" )
                {
                    ...
                    write_flat_contact( domain, vertex_hook_map, file, viennasap_layer_domain.interfaces[layer_pos] );
                }
                if ( contact_geometry == "flattop" )
                {
                    ...
                    write_flat_contact( domain, vertex_hook_map, file, viennasap_layer_domain.interfaces[layer_pos+1] );
                }
                if ( contact_geometry == "vol" )
                {
                    ...
                    write_volume_contact( domain, vertex_hook_map, file, segment_id );
                }
