...
#ifndef GML_UTIL_FOLD
#define GML_UTIL_FOLD
//
// ===================================================================================
//
// *** GML includes
...
{
   return gml::detail::fold_impl( boost::fusion::next(first), last, f(*first, state), f, 
...
{
   return gml::detail::fold_impl( boost::fusion::next(first), last, f(*first, state1, state2), f, 
          boost::fusion::result_of::equal_to<typename boost::fusion::result_of::next<First>::type, Last>() );
}
...
fold_impl(First const& first, Last const& last, State1 const& state1, State2 const& state2, State3 const& state3,
          Functor f, boost::mpl::false_ const&)
{
   return gml::detail::fold_impl( boost::fusion::next(first), last, f(*first, state1, state2, state3), f, 
          boost::fusion::result_of::equal_to<typename boost::fusion::result_of::next<First>::type, Last>() );
}
...
fold_impl(First const& first, Last const& last, State1 const& state1, State2 const& state2, State3 const& state3, State4 const& state4,
          Functor f, boost::mpl::false_ const&)
{
   return gml::detail::fold_impl( boost::fusion::next(first), last, f(*first, state1, state2, state3, state4), f, 
          boost::fusion::result_of::equal_to<typename boost::fusion::result_of::next<First>::type, Last>() );
}
...
{
   return
   gml::detail::fold_impl(  boost::fusion::begin(sequ), boost::fusion::end(sequ), state, f,  
...
{
   return 
   gml::detail::fold_impl(  boost::fusion::begin(sequ), boost::fusion::end(sequ), state1, state2, f,           
               boost::fusion::result_of::equal_to<typename boost::fusion::result_of::begin<Sequence>::type, 
                                                  typename boost::fusion::result_of::end<Sequence>::type>() );
}
...
{
   return 
   gml::detail::fold_impl(  boost::fusion::begin(sequ), boost::fusion::end(sequ), state1, state2, state3, f,           
               boost::fusion::result_of::equal_to<typename boost::fusion::result_of::begin<Sequence>::type, 
                                                  typename boost::fusion::result_of::end<Sequence>::type>() );
}
...
{
   return 
   gml::detail::fold_impl(  boost::fusion::begin(sequ), boost::fusion::end(sequ), state1, state2, state3, state4, f,           
               boost::fusion::result_of::equal_to<typename boost::fusion::result_of::begin<Sequence>::type, 
                                                  typename boost::fusion::result_of::end<Sequence>::type>() );
}
...
struct fold_impl < 1 >
{
   ...
   operator()( Sequence const& sequ, Element const& ele ) const
   {
      ...
      return gml::fold(sequ, ele, gml::functional::caller());
   }
   // ---------------------------------------------
...
struct fold_impl < 2 >
{
   ...
   {
      BOOST_MPL_ASSERT(( boost::fusion::traits::is_sequence< Sequence > ));  
      return gml::fold( sequ, ele1, ele2, gml::functional::caller() );
   }
   // ---------------------------------------------
...
struct fold_impl < 3 >
{
   ...
   {
      BOOST_MPL_ASSERT(( boost::fusion::traits::is_sequence< Sequence > ));  
      return gml::fold( sequ, ele1, ele2, ele3, gml::functional::caller() );
   }
   // ---------------------------------------------
...
struct fold_impl < 4 >
{
   ...
   {
      BOOST_MPL_ASSERT(( boost::fusion::traits::is_sequence< Sequence > ));  
      return gml::fold( sequ, ele1, ele2, ele3, ele4, gml::functional::caller() );
   }
   // ---------------------------------------------
...
// ===================================================================================
//
boost::phoenix::function< gml::functional::fold_impl< 1 > > const fold  = gml::functional::fold_impl< 1 >();
boost::phoenix::function< gml::functional::fold_impl< 1 > > const fold1 = gml::functional::fold_impl< 1 >();
boost::phoenix::function< gml::functional::fold_impl< 2 > > const fold2 = gml::functional::fold_impl< 2 >();
boost::phoenix::function< gml::functional::fold_impl< 3 > > const fold3 = gml::functional::fold_impl< 3 >();
boost::phoenix::function< gml::functional::fold_impl< 4 > > const fold4 = gml::functional::fold_impl< 4 >();
//
// ===================================================================================
//
