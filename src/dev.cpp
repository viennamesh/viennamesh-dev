...
//   bnd_wrapper_type                    wrapdata(my_bnd_reader);      
...
//   result_type result = hull_mesher(wrapdata());
...
//   typedef hull_quality_adaptor_type::result_type       result_type;
//   result_type result = hull_quality(orienter(hull_mesher(wrapped_data)));
