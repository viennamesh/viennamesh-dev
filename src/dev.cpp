...
int main(int argc, char *argv[])
{
   ...
   typedef viennamesh::result_of::mesh_generator<viennamesh::tag::netgen2>::type        netgen_volume_mesh_generator_type;
   netgen_volume_mesh_generator_type      volume_mesher;            

//   volume_mesher(orienter(hull_mesher(wrapped_data)));

//   viennamesh::mesher   mymesh;
//   mymesh(); 
