...
#if !defined(GSSE_ALGORITHM_ISBOUNDARY_HH)
#define GSSE_ALGORITHM_ISBOUNDARY_HH
//
// ===================================================================================
//
// *** GSSE include
...
struct is_boundary_impl < 0, DIMCellComplex, CellTopology > // Vertex
{
               ...
               CellContainer        & cell_cont) 
   {
      ...
      //
      typedef std::map< typename gsse::result_of::val< EdgeOnVertex_result >::type, bool > UniqueEdgeSet;
      UniqueEdgeSet   edge_result_unique;

      for( size_t ei = 0; ei < gsse::size( edge_result ); ei++ )
      {
      ...
      size_t edge_size_unique = gsse::size( edge_result_unique );
...
struct is_boundary
{
   ...
   operator() (TopoElement     const& ele,
               ...
               CellContainer        & cell_cont) 
   {  
      return gsse::algorithm::detail::is_boundary_impl< 
         gsse::result_of::size< TopoElement >::value-1,
         DIM,
         CellTopology
