...
\begin{figure}[!ht]
   ...
   {
      \fbox{\includegraphics[scale=0.2]{figures/raw/cmos_orig_total.eps}}
   }
   \subfloat%[\textsc{Adapted Mesh}]
   {
      \fbox{\includegraphics[scale=0.20]{figures/raw/cmos_adapted_total.eps}}
   }

   \subfloat%[\textsc{Initial Mesh}]
   {
      \fbox{\includegraphics[scale=0.2]{figures/raw/cmos_orig_total_back.eps}}
   }
   \subfloat%[\textsc{Adapted Mesh}]
   {
      \fbox{\includegraphics[scale=0.20]{figures/raw/cmos_adapted_total_back.eps}}
   }
   \caption{A CMOS structure. \textbf{left:} The initial mesh is shown. 
   \textbf{right:} The adapted mesh is shown. }
\end{figure}
...
\begin{figure}[!ht]
   ...
   \subfloat%[\textsc{Initial Mesh}]
   {
      \fbox{\includegraphics[scale=0.2]{figures/raw/cmos_orig_close.eps}}
   }
   \subfloat%[\textsc{Adapted Mesh}]
   {
      \fbox{\includegraphics[scale=0.20]{figures/raw/cmos_adapted_close.eps}}
   }

   \subfloat%[\textsc{Initial Mesh}]
   {
      \fbox{\includegraphics[scale=0.2]{figures/raw/cmos_orig_cut.eps}}
   }
   \subfloat%[\textsc{Adapted Mesh}]
   {
      \fbox{\includegraphics[scale=0.20]{figures/raw/cmos_adapted_cut.eps}}
   }
   \caption{A CMOS structure. \textbf{left:} The initial mesh is shown. 
   \textbf{right:} The adapted mesh is shown.}
\end{figure}
...
\begin{figure}[!ht]
   ...
   \subfloat%[\textsc{Initial Mesh}]
   {
      \fbox{\includegraphics[scale=0.2]{figures/raw/cyl_mask_etched_flux_orig_total.eps}}
   }
   \subfloat%[\textsc{Adapted Mesh}]
   {
      \fbox{\includegraphics[scale=0.20]{figures/raw/cyl_mask_etched_flux_adapted_total.eps}}
   }

   \subfloat%[\textsc{Initial Mesh}]
   {
      \fbox{\includegraphics[scale=0.2]{figures/raw/cyl_mask_etched_flux_orig_top.eps}}
   }
   \subfloat%[\textsc{Adapted Mesh}]
   {
      \fbox{\includegraphics[scale=0.20]{figures/raw/cyl_mask_etched_flux_adapted_top.eps}}
   }
   \caption{A CMOS structure. \textbf{left:} The initial mesh is shown. 
   \textbf{right:} The adapted mesh is shown.}
\end{figure}
...
\begin{figure}[!ht]
   ...
   \subfloat%[\textsc{Initial Mesh}]
   {
      \fbox{\includegraphics[scale=0.2]{figures/raw/cyl_mask_etched_flux_orig_close.eps}}
   }
   \subfloat%[\textsc{Adapted Mesh}]
   {
      \fbox{\includegraphics[scale=0.20]{figures/raw/cyl_mask_etched_flux_adapted_close.eps}}
   }

   \subfloat%[\textsc{Initial Mesh}]
   {
      \fbox{\includegraphics[scale=0.2]{figures/raw/cyl_mask_etched_flux_orig_cut.eps}}
   }
   \subfloat%[\textsc{Adapted Mesh}]
   {
      \fbox{\includegraphics[scale=0.20]{figures/raw/cyl_mask_etched_flux_adapted_cut.eps}}
   }
   \caption{Etched Hole with Cylindrical Mask. \textbf{left:} The initial mesh is shown. 
   \textbf{right:} The adapted mesh is shown.}
\end{figure}
