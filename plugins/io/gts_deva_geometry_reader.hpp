...
namespace viennamesh
{
  namespace io
  {
    ...
    struct gts_deva_geometry_reader
    {
...
//         inner_root->print();
        ...
        std::map<std::string, std::vector<VertexHandleType> > vertex_map;
        std::map<std::string, std::vector< std::vector<LineHandleType> > > line_map;
        ...
        for (gts_deva::token::iterator sik = segments->begin(); sik != segments->end(); ++sik)
        {
          ...
          {
//             std::cout << "Found Geometry segment!! " << name << std::endl;
...
//             std::cout << "Using facelist with name " << facelist_name << std::endl;
            ...
            typename std::map<std::string, std::vector< std::vector<LineHandleType> > >::iterator flit = line_map.find( facelist_name );
...
//               std::cout << "Using pointlist with name " << pointlist_name << std::endl;
              ...
              typename std::map<std::string, std::vector<VertexHandleType> >::iterator plit = vertex_map.find( pointlist_name );
...
//                 std::cout << "#points = " << num_points << std::endl;
                ...
                std::vector<VertexHandleType> & vertices = vertex_map[ pointlist_name ];
...
//             int num_elements = atoi( mesh_element_list->attribute(0).c_str() );
            ...
            typedef typename SegmentationT::segment_handle_type SegmentHandleType;
            SegmentHandleType & current_segment = segmentation.make_segment();
