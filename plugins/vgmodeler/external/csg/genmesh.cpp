...
#define TCL_ERROR 1
  ...
  {
    std::cout << ".. ENTER FindPoints .." << std::endl;
  ...
  static void FindEdges (CSGeometry & geom, Mesh & mesh, const bool setmeshsize = false)
  {
	...
	std::cout << "change from " << mesh.LineSegment(i).si << std::endl;
	...
	for (int i = 0; i < geom.identifications.Size(); i++)
	  {
	    ...
	    std::cout << "identification " << i << " is " << *geom.identifications[i] << std::endl;
      ...
      for (SegmentIndex si = 0; si < mesh.GetNSeg(); si++)
	{
	  ...
	  for (int j = 0; j < loc.Size(); j++)
		...
		{ 
	      ...
	      std::cout << "mat " << mat << std::endl << "rhs " << rhs << std::endl << "sol " << sol << std::endl;
  ...
  static void MeshSurface (CSGeometry & geom, Mesh & mesh)
  {
    ...
    std::cout << "[FS] .. number of FaceDescriptors 1: " << mesh.GetNFD() << std::endl;
    int bccnt=0;
    ...
    std::cout << "[FS] .. number of FaceDescriptors 2: " << mesh.GetNFD() << std::endl;
    ...
    //!!
    std::cout << "[FS] .. number of FaceDescriptors 3: " << mesh.GetNFD() << std::endl;
    ...
    //!!
    std::cout << "[FS] .. number of FaceDescriptors 4: " << mesh.GetNFD() << std::endl;
    ...
    std::cout << "[FS] .. number of FaceDescriptors 5: " << mesh.GetNFD() << std::endl;
