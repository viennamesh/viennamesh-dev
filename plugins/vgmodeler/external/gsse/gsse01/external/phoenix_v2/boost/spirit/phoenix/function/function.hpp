...
{
    //  Bring in the detail::function_eval<0..N> definitions
    #include <boost/spirit/phoenix/function/detail/function_eval.hpp>
    ...
    struct function
    {
       ...
       function(F const& f) : f(f) {}
        ...
        #include <boost/spirit/phoenix/function/detail/function_call.hpp>
