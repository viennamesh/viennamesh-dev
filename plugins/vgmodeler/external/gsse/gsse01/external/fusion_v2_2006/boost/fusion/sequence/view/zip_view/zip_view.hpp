...
namespace boost { namespace fusion {
    ...
    namespace detail
    {
        ...
        struct all_references
            : result_of::equal_to<typename result_of::find_if<Sequences, mpl::not_<is_reference<mpl::_> > >::type, typename result_of::end<Sequences>::type>
        {};

        template<typename Sequences>
        struct all_same_size_impl
        {
            typedef mpl::transform_view<Sequences, result_of::size<remove_reference<mpl::_> > > sizes;
    ...
    struct zip_view : sequence_base< zip_view<Sequences> >
    {
        ...
        typedef typename result_of::as_vector<Sequences>::type sequences;
