...
int main()
{
    using namespace boost::fusion;
    {
        ...
        BOOST_MPL_ASSERT((boost::mpl::equal_to<result_of::size<view>::type, result_of::size<int_vector>::type>));
        BOOST_STATIC_ASSERT((result_of::size<view>::value == 2));
        ...
        BOOST_STATIC_ASSERT((result_of::distance<result_of::begin<view>::type, result_of::end<view>::type>::value == 2));

        BOOST_MPL_ASSERT((boost::is_same<result_of::value_at_c<view,0>::type, vector<int,char> >));
        BOOST_MPL_ASSERT((boost::is_same<result_of::value_of<result_of::begin<view>::type>::type, vector<int,char> >));
    }
    {
    ...
    using namespace boost::fusion;
    {
        ...
        BOOST_MPL_ASSERT((boost::is_same<result_of::value_at_c<view,0>::type, vector<int,char,char> >));
        BOOST_MPL_ASSERT((boost::is_same<result_of::value_of<result_of::begin<view>::type>::type, vector<int,char,char> >));
    }
