...
/*
 //Assignment operator
 tetgenio& operator= (const tetgenio& obj)
 {
   if (this != &obj) //avoids self-assignement
   {
      //assign pointers
      if (obj.pointlist != (REAL *) NULL) {
        this->pointlist = obj.pointlist;
        std::cout << "assign: this " << this->pointlist << std::endl;
        std::cout << "assign: obj  " << obj.pointlist << std::endl;
      }
      if (obj.pointattributelist != (REAL *) NULL) {
        this->pointattributelist = obj.pointattributelist;
      }
      if (obj.pointmtrlist != (REAL *) NULL) {
        this->pointmtrlist = obj.pointmtrlist;
      }
      if (obj.pointmarkerlist != (int *) NULL) {
        this->pointmarkerlist = obj.pointmarkerlist;
      }
      if (obj.pointparamlist != (pointparam *) NULL) {
        this->pointparamlist = obj.pointparamlist;
      }
  
      if (obj.tetrahedronlist != (int *) NULL) {
        this->tetrahedronlist = obj.tetrahedronlist;
      }
      if (obj.tetrahedronattributelist != (REAL *) NULL) {
        this->tetrahedronattributelist = obj.tetrahedronattributelist;
      }
      if (obj.tetrahedronvolumelist != (REAL *) NULL) {
        this->tetrahedronvolumelist = obj.tetrahedronvolumelist;
      }
      if (obj.neighborlist != (int *) NULL) {
        this->neighborlist = obj.neighborlist;
      }
  
      if (obj.trifacelist != (int *) NULL) {
        this->trifacelist = obj.trifacelist;
      }
      if (obj.trifacemarkerlist != (int *) NULL) {
        this->trifacemarkerlist = obj.trifacemarkerlist;
      }
      if (obj.o2facelist != (int *) NULL) {
        this->o2facelist = obj.o2facelist;
      }
      if (obj.adjtetlist != (int *) NULL) {
        this->adjtetlist = obj.adjtetlist;
      }
  
      if (obj.edgelist != (int *) NULL) {
        this->edgelist = obj.edgelist;
      }
      if (obj.edgemarkerlist != (int *) NULL) {
        this->edgemarkerlist = obj.edgemarkerlist;
      }
      if (obj.o2edgelist != (int *) NULL) {
        this->o2edgelist = obj.o2edgelist;
      }
      if (obj.edgeadjtetlist != (int *) NULL) {
        this->edgeadjtetlist = obj.edgeadjtetlist;
      }
  /*
      if (obj.facetlist != (facet *) NULL) {
        facet *f;
        polygon *p;
        for (i = 0; i < obj.numberoffacets; i++) {
          f = &obj.facetlist[i];
          for (j = 0; j < f->numberofpolygons; j++) {
            p = &f->polygonlist[j];
            delete [] p->vertexlist;
        ...
        delete [] obj.facetlist;
      }
      if (obj.facetmarkerlist != (int *) NULL) {
        delete [] facetmarkerlist;
      }
  
      if (obj.holelist != (REAL *) NULL) {
        delete [] holelist;
      }
      if (obj.regionlist != (REAL *) NULL) {
        delete [] regionlist;
      }
      if (obj.facetconstraintlist != (REAL *) NULL) {
        delete [] facetconstraintlist;
      }
      if (obj.segmentconstraintlist != (REAL *) NULL) {
        delete [] segmentconstraintlist;
      }
      if (obj.vpointlist != (REAL *) NULL) {
        delete [] vpointlist;
      }
      if (obj.vedgelist != (voroedge *) NULL) {
        delete [] vedgelist;
      }
      if (obj.vfacetlist != (vorofacet *) NULL) {
        for (i = 0; i < numberofvfacets; i++) {
          delete [] vfacetlist[i].elist;
        }
        delete [] vfacetlist;
      }
      if (obj.vcelllist != (int **) NULL) {
        for (i = 0; i < numberofvcells; i++) {
          delete [] vcelllist[i];
        }
        delete [] vcelllist;
