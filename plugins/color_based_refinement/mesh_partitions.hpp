...
/*
    ...
    /*        }
        ...
        viennamesh::info(1) << "Scheduling Duration: " << sched_time << std::endl;
    }
    //-------------------------------------------------------------------------------------------------//
    ...
    if (coloring_algorithm == "parallel")
    {
        viennamesh::info(1) << "Coloring vertices using a parallel graph coloring algorithm with " << nthreads << " threads" << std::endl;
