...
namespace viennamesh
{
  ...
  void map_segments_impl(viennagrid::base_mesh<mesh_is_const> const & src_mesh,
  ...
  std::string map_segments::name() { return "map_segments"; }

  bool map_segments::run(viennamesh::algorithm_handle &)
  {
    ...
    map_segments_impl( input_mesh(), output_mesh(), segment_mapping );
